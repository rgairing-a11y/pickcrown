...
// IMPORTANT: This expects the bracket structure to already be defined with empty matchups
async function advanceWinnerToNextRound(eventId, currentRoundOrder, bracketPosition, winnerTeamId) {
  ...
  // Find the existing next round matchup - DO NOT CREATE NEW ONES
  ...
  // If no next matchup exists, that's fine - bracket may not be fully set up yet
}
